...
f=open("WhatsApp Chat with Kushagra.txt","r",encoding="utf-8")
data =f.read()
# print(data)
...
# print(year_month_list[["year_month","year","month","messages"]])
df["hour"]=df["date_time"].dt.hour
hourly_messages=df.groupby("hour").count()["messages"].reset_index()
print(hourly_messages)